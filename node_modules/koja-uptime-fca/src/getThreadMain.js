...
module.exports = function(defaultFuncs, api, ctx) {
  return function getThreadInfoGraphQL(threadID, callback) {
    ...
    //! được tìm thấy vào giữa tháng 8/2022 bởi @KemDev - đã được chia sẻ cho cộng đồng và Dino Team Public group 🤴
    //* những code tương tự muliti thread như này đều có thể là copy idea 🐧
    //* đã áp dụng vào fca mới(cloud - fca(private)) vào cuối tháng 8/2022 bởi @IteralingCode(Hidden Member( always :) )) - Synthetic 4 - @Dino Team
    //*cập nhật dự án bị bỏ rơi này vào ngày 19/11/2022 bởi @KemDev(Owner) - Synthetic 1  - @Dino Team nhằm đáp ứng nhu cầu của client !
