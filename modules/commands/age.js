...
module.exports.run = async function ({ event, args, api }) {
  ...
  // Nỗ não :>
  return api.sendMessage(`-Date of birth: ${input}\n\n-The number of years that have passed: ${nam} year \n-The number of months that have passed: ${thang} month \n-The number of weeks that have passed: ${tuan} week \n-Number of days passed: ${ngay} day \n-Number of hours passed: ${gio} hour \n-Elapsed minutes: ${phut} minute \n-The number of seconds that have passed: ${giay} second `,event.threadID,event.messageID);
    }