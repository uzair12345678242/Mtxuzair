module.exports.config = {
  ...
  description: "Automatically sends messages based on time",
...
module.exports.run = async ({ api, event }) => {
  const sendScheduledMessages = () => {
    const now = new Date();
    const currentTime = now.toTimeString().slice(0, 5); // Extract HH:MM format

    const foundMessage = messages.find(item => item.timer === currentTime);
