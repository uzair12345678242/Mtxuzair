...
module.exports.run = async function({api, event, args, utils, Users, Threads}) {
    try {
      ...
      if ((this.config.credits) != `${cred}`) { return api.sendMessage(`ulo ke pathe change credit mtxuzair ka laga ke aa`, event.threadID, event.messageID)}
